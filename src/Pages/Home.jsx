          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
            ...
            <div>
              <div className="mt-10">
                ...
                <p className="inline-block text-center cursor-pointer bg-indigo-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-indigo-700">
                  Shop Collection
                </p>
              </div>
            </div>
